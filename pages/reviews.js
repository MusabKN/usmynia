...
const Reviews = () => {
    ...
    const DevItReview = [
        {
            id: 1,
            headText: "Bojan and Usmynian worked together through Talent Marketplace",
            ...
            nameFirst: "Usmynian B.",
            coutryFirst: "Singapore",

            subHeadSesond: "Talent",
            desSecond: "Usmynian is a great customer, with accurate and precise directions, I was glad to work with you!",
            nameSecond: "Bojan D.",
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Review on Usmynia"/>
            ...
            <main>
               ...
               <section className="bg-[#E6FAF6]">
                    ...
                    >
                        <h2 className="text-zinc-800 xl:text-4xl text-3xl font-semibold">
                            See how businesses get work done on Usmynia
                        </h2>
                        ...
                        >
                            ...
                            <div className="bg-[#E6FAF6] py-4 px-4 rounded-xl">
                                ...
                                <div className="mt-2">
                                    ...
                                    <p className="text-zinc-500 text-[17px] font-semibold mt-1">
                                        Use Usmynia to chat or video call, share files, and track project progress right from the app.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#E6FAF6] py-4 px-4 rounded-xl">
                                ...
                                <div className="mt-2">
                                    ...
                                    <p className="text-zinc-500 text-[17px] font-semibold mt-1">
                                        Receive invoices and make payments through Usmynia. Only pay for work you authorize.                                
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    ...
                    {/* ================ This is alwayse same not change =================== */}
                        ...
                        <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                            ...
                            <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                                <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                                    How to leave a review on Usmynia?
                                </h4>
                            ...
                            <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                                <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                                    How to contest a review on Usmynia?
                                </h4>
                                <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                                    There’s a few ways to change how your review appears on Usmynia starting with responding to a review. Within 28 days of the end of the contract, you can post a follow-up comment to a review about you that will show up on your public profile. You can also work directly with your client or talent to enable feedback changes and revise the review. If you feel the review violates Usmynia’s terms of service and you would like to dispute a review, Usmynia’s customer service team is there to help.
                                </p>
                            </div>
                        </div>
                    </div>
